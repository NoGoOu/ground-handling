...
- Utolsó commit: `0609497` – feat: add the planning data model and permission (a 2. lépés commitja ezt követi)
- Tesztek: `npm test` → 313 teszt, mind zöld
...
- 4. mérföldkő, 3. lépés: algoritmus, minimális pozíciószám a korlátokkal.
