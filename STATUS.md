...
- Utolsó commit: `7a7f763` – feat: collect the occupancy windows of a plan day (a 3. lépés commitja ezt követi)
- Tesztek: `npm test` → 329 teszt, mind zöld
...
- 4. mérföldkő, 4. lépés: kiegyenlítés, döntetlen-feloldás, mutatók.
